<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="updatePromotion.aspx.cs" Inherits="WebApplication1.admin.updatePromotion" %>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="review-tab-pro-inner">
                                    <ul id="myTab3" class="tab-review-design">
                                        <li class="active"><a href="#description"><i class="fa fa-edit" aria-hidden="true"></i>Modification </a></li>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <asp:TextBox ID="txtpromoID" runat="server" CssClass="form-control readonly-textbox" Placeholder="Promotion ID" Enabled="false"></asp:TextBox>
                                                        </div>
                                                        ...
                                                        <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtStartDate" ErrorMessage="Please enter date in MM/dd/yyyy format." OnServerValidate="ValidateDateFormat" ValidationGroup="Start"></asp:CustomValidator>

                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="fa fa-picture-o" aria-hidden="true"></i></span>
                                                            <asp:FileUpload ID="fupNewImage" runat="server" ForeColor="Red" />
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="fa fa-picture-o" aria-hidden="true"></i></span>
                                                            <asp:FileUpload ID="fupNewImage2" runat="server" ForeColor="Red" />
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="fa fa-picture-o" aria-hidden="true"></i></span>
                                                            <asp:FileUpload ID="fupNewImage3" runat="server" ForeColor="Red" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="txtProductName" runat="server" CssClass="form-control readonly-textbox " Placeholder="Product Name" Enabled="false"></asp:TextBox>
                                                        </div>
                                                        ...
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <asp:TextBox ID="txtpromoColor" runat="server" CssClass="form-control" Placeholder="Color"></asp:TextBox>
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
