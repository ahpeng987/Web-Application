<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="OrderAdmin.aspx.cs" Inherits="WebApplication1.admin.OrderAdmin" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="../admin/AddOrder.aspx">Add New Order</a>
                            </div>
                                    ...
                                    <asp:Repeater ID="rptOrders" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%# Eval("totalAmt", "{0:C}") %></td>
                                                <td><%# Eval("paymentID") %></td>
                                                <td>
                                                    <asp:Button runat="server" Text="Edit" CssClass="btn btn-primary" OnClick="EditOrder" CommandArgument='<%# Eval("orderID") %>' />
                                                    <asp:Button runat="server" Text="Delete" CssClass="btn btn-danger" OnClick="DeleteOrder" CommandArgument='<%# Eval("orderID") %>' />
                                                </td>
                                            </tr>
                            ...
                            <div class="btn btn-ctl-bt waves-effect waves-light m-r-10">
                                <a href="../admin/CancellationRequests.aspx" style="color: white;">Cancel Requests</a>
                            </div>
                        </div>
                    </div>
                </div>
