<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PromotionAdmin.aspx.cs" Inherits="WebApplication1.admin.PromotionAdmin" %>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="PromotionEdit.aspx">Add Product</a>
                            </div>
                            <table>
                                <tr>
                                    <th class="auto-style1">Image</th>
                                    <th class="auto-style1">ID</th>
                                    <th class="auto-style1">Product Title</th>
                                    <th class="auto-style1">Description</th>
                                    <th class="auto-style1">Quantity</th>
                                    <th class="auto-style1">Ori Price</th>
                                    <th class="auto-style1">Offered Price</th>
                                    <th class="auto-style1">Size (UK)</th>
                                    <th class="auto-style1">Color </th>
                                    <th class="auto-style1">Modification</th>
                                </tr>
                                <asp:Repeater ID="Repeater1" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            <td>
                                                <asp:Image ID="imgPromo" runat="server" ImageUrl='<%# "~/admin/img/" + Eval("promoImg") %>' Width="500" Height="100" />
                                            </td>
                                            <td><%# Eval("promoID") %></td>
                                            <td><%# Eval("prodName") %></td>
                                            <td><%# Eval("promoDescript") %></td>

                                            <td><%# Eval("prodQty") %></td>
                                            <td><%# Eval("oriPrice") %></td>
                                            <td><%# Eval("disPrice") %></td>
                                            <td><%# Eval("prodSize") %></td>
                                            <td><%# Eval("promoColor") %></td>



                                            <td>
                                                <asp:Button ID="btnDelete" runat="server" Text="Delete" OnClick="btnDelete_Click" data-promo-id='<%# Eval("promoID") %>' CssClass="btn btn-danger" />
                                                <asp:Button ID="btnModify" runat="server" Text="Modify" CommandArgument='<%# Eval("promoID") %>' PostBackUrl='<%# "~/admin/updatePromotion.aspx?promoID=" + Eval("promoID") %>' CssClass="btn btn-primary" />
