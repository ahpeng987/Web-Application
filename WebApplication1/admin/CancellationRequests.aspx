<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="CancellationRequests.aspx.cs" Inherits="WebApplication1.admin.CancellationRequests" %>
                        ...
                        <div class="product-status-wrap">
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <asp:Repeater ID="rptCancellationRequests" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                    <td><%# Eval("OrderID") %></td>
                                                    <td><%# Eval("RequestDate", "{0:yyyy-MM-dd}") %></td>
                                                    <td><%# Eval("RequesterEmail") %></td>
                                                    <td><%# Eval("Reason") %></td>
                                                    <td><%# Eval("Status") %></td>
                                                    <td>
                                                        <asp:Button runat="server" ID="btnApprove" Text="Approve" CssClass="btn btn-success" OnClick="HandleCancellationRequest" OnClientClick="return confirm('Confirm Approval?')" CommandArgument='<%# Eval("RequestID") %>' />
                                                        <asp:Button runat="server" ID="btnDecline" Text="Decline" CssClass="btn btn-danger" OnClick="HandleCancellationRequest" OnClientClick="return confirm('Confirm Decline?')" CommandArgument='<%# Eval("RequestID") %>' />
                                                    </td>
                                                    <!-- Hidden Label to store OrderID -->
