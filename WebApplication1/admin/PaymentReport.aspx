<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="PaymentReport.aspx.cs" Inherits="WebApplication1.admin.PaymentReport" %>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <asp:GridView ID="GridView1" runat="server" ForeColor="WhiteSmoke" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="True" CellPadding="4" GridLines="None" Style="margin: 0 auto; width: 100%; text-align: center;">
                                <AlternatingRowStyle BackColor="#86c5da" />
                                <Columns>
