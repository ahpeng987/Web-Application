<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DeliveryAdd.aspx.cs" Inherits="WebApplication1.admin.DeliveryAdd" %>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="delivery-form">
                            <h2 style="color: white;">Add New Delivery</h2>
                            <div class="form-group">
                                <label for="ddlOrder" style="color: white;">Order ID:</label>
                                <asp:DropDownList ID="ddlOrder" runat="server" CssClass="form-control" AppendDataBoundItems="true">
                                    <asp:ListItem Text="-- Select Order --" Value="" />
                                </asp:DropDownList>
                            </div>

                            <div class="form-group">
                                <label for="txtDeliveryAddress" style="color: white;">Delivery Address:</label>
                                <asp:TextBox ID="txtDeliveryAddress" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="4"></asp:TextBox>
                            </div>

                            <div class="form-group">
                                <label for="ddlCourier" style="color: white;">Courier:</label>
                                <asp:DropDownList ID="ddlCourier" runat="server" CssClass="form-control">
                                    <asp:ListItem Text="-- Select Courier --" Value="" />
                                    <asp:ListItem Text="PosLaju" Value="PosLaju" />
                                    <asp:ListItem Text="CityLink Express" Value="CityLink Express" />
                                    <asp:ListItem Text="JDExpress" Value="JDExpress" />
                                    <asp:ListItem Text="PolarExpress" Value="PolarExpress" />
                                </asp:DropDownList>
                            </div>

                            <asp:Button ID="btnAddDelivery" runat="server" Text="Add Delivery" CssClass="btn btn-primary" OnClick="btnAddDelivery_Click" OnClientClick="return confirm('Are you sure you want to add Delivery?');" />
